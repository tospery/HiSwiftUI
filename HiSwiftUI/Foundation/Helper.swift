...
public func logEnvironment() {
    ...
    log("网页地址: \(Bundle.main.baseWebUrl)", module: Module.hiSwiftUI)
    log("服务地址: \(Bundle.main.baseApiUrl)", module: Module.hiSwiftUI)
    //log("通用链接: \(Bundle.main.baseUnivLink)", module: Module.hiSwiftUI)
